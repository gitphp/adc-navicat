            ...
            [
                ...
                'children' => [
                    ...
                    [
                        'id' => 13,
                        'menu_name' => '权限管理',
                        'menu_path' => '/backend/permission/index',
                    ...
                    [
                        'id' => 14,
                        'menu_name' => '菜单管理',
                        'menu_path' => '/backend/menu/index',
                        'menu_icon' => 'layui-icon-template-1',
                        'parent_id' => 1,
                    ],
                ],
            ],
            [
                ...
                'children' => [
                    [
                        'id' => 21,
                        'menu_name' => '分类管理',
                        'menu_path' => '/backend/category/index',
                    ...
                    [
                        'id' => 22,
                        'menu_name' => '文章管理',
                        'menu_path' => '/backend/article/index',
