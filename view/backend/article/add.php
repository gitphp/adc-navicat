        ...
        <form class="layui-form" action="" method="post" id="articleForm">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="title" lay-verify="required" placeholder="请输入文章标题" class="layui-input" style="width: 600px;">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="source_url" placeholder="转载时填写原文链接" class="layui-input">
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="art_cover" id="art_cover" placeholder="请输入封面图URL" class="layui-input" style="width: 500px; display: inline-block;">
                    ...
                    <div class="layui-tab" lay-filter="contentType">
                        ...
                        <div class="layui-tab-content">
                            <div class="layui-tab-item layui-show">
                                <textarea name="art_content" id="richTextEditor" lay-verify="required" placeholder="请输入文章内容" class="layui-textarea" style="height: 300px;"></textarea>
                            </div>
                            <div class="layui-tab-item">
                                <textarea name="art_content_md" id="markdownEditor" placeholder="请输入Markdown内容" class="layui-textarea" style="height: 300px;"></textarea>
                            </div>
                            <div class="layui-tab-item">
                                <textarea name="art_content_text" id="plainTextEditor" placeholder="请输入纯文本内容" class="layui-textarea" style="height: 300px;"></textarea>
                            </div>
                        </div>
                    </div>
                    <input type="hidden" name="content_type" value="1" id="content_type">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea name="summary" placeholder="文章摘要（自动截取或手动填写）" class="layui-textarea" style="width: 600px; height: 80px;"></textarea>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="art_status">
                        ...
                        <option value="<?= $option['value'] ?>" <?php if ($option['value'] == 1) echo 'selected'; ?>><?= $option['label'] ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="is_original" value="1" title="是" checked>
                        <input type="radio" name="is_original" value="0" title="否">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">允许评论</label>
                    <div class="layui-input-block">
                        <input type="radio" name="is_commentable" value="1" title="是" checked>
                        <input type="radio" name="is_commentable" value="0" title="否">
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="seo_title" placeholder="为空时取文章标题" class="layui-input" style="width: 600px;">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="seo_keywords" placeholder="请输入SEO关键词，多个用逗号分隔" class="layui-input" style="width: 600px;">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea name="seo_description" placeholder="请输入SEO描述" class="layui-textarea" style="width: 600px; height: 80px;"></textarea>
                </div>
            </div>
            ...
            <div class="form-footer">
                ...
                <button type="button" class="layui-btn" onclick="submitForm()">提交审核</button>
                <button type="button" class="layui-btn layui-btn-normal" onclick="publishArticle()">直接发布</button>
