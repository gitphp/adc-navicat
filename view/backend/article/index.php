<div class="content-header">
    ...
    <div class="content-actions">
        <button class="layui-btn" onclick="addArticle()">
            <i class="layui-icon layui-icon-add"></i> 添加文章
        </button>
    </div>
</div>
...
<div class="search-area">
    <div class="search-label">文章标题：</div>
    <input type="text" id="title" placeholder="请输入文章标题" class="layui-input" style="width: 200px; display: inline;">
    <div class="search-label">分类：</div>
    <select id="category_id" class="layui-input" style="width: 150px; display: inline;">
        <option value="">全部</option>
    </select>
    <div class="search-label">状态：</div>
    <select id="art_status" class="layui-input" style="width: 120px; display: inline;">
        <option value="">全部</option>
    ...
    <div class="search-label">置顶：</div>
    <select id="is_top" class="layui-input" style="width: 100px; display: inline;">
        <option value="">全部</option>
        <option value="1">是</option>
        <option value="0">否</option>
    </select>
    <div class="search-label">作者：</div>
    <input type="text" id="author_name" placeholder="请输入作者姓名" class="layui-input" style="width: 150px; display: inline;">
    <div class="search-label">开始日期：</div>
    <input type="date" id="start_date" class="layui-input" style="width: 130px; display: inline;">
    <div class="search-label">结束日期：</div>
    <input type="date" id="end_date" class="layui-input" style="width: 130px; display: inline;">
