<div class="search-area">
    ...
    <input type="text" id="category_name" placeholder="请输入关键字" class="layui-input" style="width: 200px; display: inline-block;">
    <div class="search-label">状态:</div>
    <select id="cat_status" class="layui-input" style="width: 120px; display: inline-block;">
...
<script type="text/html" id="toolbar">
    <a class="layui-btn layui-btn-xs layui-btn-primary" lay-event="addChild">添加子分类</a>
    <a class="action-link" lay-event="edit">修改</a>
