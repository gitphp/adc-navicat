    ...
    <div class="form-container">
        ...
        <form class="layui-form" action="" method="post" id="menuForm">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="parent_id" id="parent_id" class="layui-input">
                        <option value="0" <?php if ($menu->parent_id == 0) : ?>selected<?php endif; ?>>无（顶级菜单）</option>
                        <?php foreach ($parent_options as $option) : ?>
                        <option value="<?= $option['id'] ?>" <?php if ($menu->parent_id == $option['id']) : ?>selected<?php endif; ?>>
                            <?= htmlspecialchars($option['menu_name']) ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="menu_path" id="menu_path" 
                           ...
                           value="<?= htmlspecialchars($menu->menu_path) ?>">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="component" id="component" 
                           ...
                           value="<?= htmlspecialchars($menu->component) ?>">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="permission_code" id="permission_code" 
                           ...
                           value="<?= htmlspecialchars($menu->permission_code) ?>">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="number" name="menu_sort" id="menu_sort" 
                           placeholder="请输入排序号" class="layui-input" style="width: 150px;"
                           value="<?= htmlspecialchars($menu->menu_sort) ?>">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="menu_status" value="1" title="启用" 
                           <?php if ($menu->menu_status == 1) : ?>checked<?php endif; ?>>
                    <input type="radio" name="menu_status" value="0" title="禁用" 
                           <?php if ($menu->menu_status == 0) : ?>checked<?php endif; ?>>
                </div>
            </div>
