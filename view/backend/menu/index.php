<div class="content-header">
    ...
    <div class="content-actions">
        <button class="layui-btn layui-btn-green" onclick="addMenu()">
            <i class="layui-icon layui-icon-add"></i> 添加菜单
        </button>
    </div>
</div>
