        ...
        <form class="layui-form" action="" method="post" id="permissionForm">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="parent_id" id="parent_id" class="layui-input">
                        ...
                        <option value="<?= $option['id'] ?>"><?= htmlspecialchars($option['per_name']) ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="hidden" name="per_method" id="per_method" value="">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="number" name="per_sort" id="per_sort" value="0" 
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="per_status" value="1" title="启用" checked>
