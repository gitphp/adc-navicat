<div class="content-header">
    <div class="content-title">权限管理</div>
    <div class="content-actions">
        <button class="layui-btn layui-btn-green" onclick="addPermission()">
            <i class="layui-icon layui-icon-add"></i> 添加权限
        </button>
    </div>
</div>

<div class="search-area">
    <div class="search-label">权限名称：</div>
    <input type="text" id="per_name" placeholder="请输入权限名称" class="layui-input" style="width: 200px; display: inline;">
    <div class="search-label">权限标识：</div>
    <input type="text" id="per_code" placeholder="请输入权限标识" class="layui-input" style="width: 200px; display: inline;">
    <div class="search-label">权限类型：</div>
    ...
    <div class="search-label">权限状态：</div>
