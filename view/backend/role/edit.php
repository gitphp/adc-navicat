    ...
    <div class="form-container">
        ...
        <form class="layui-form" action="" method="post" id="roleForm">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="role_code" id="role_code" required lay-verify="required" 
                           ...
                           value="<?= htmlspecialchars($role->role_code) ?>"
                           <?php if ($role->role_type == 1) : ?>readonly class="readonly-input"<?php endif; ?>>
                    <?php if ($role->role_type == 1) : ?>
                    <span style="color: #999; font-size: 12px;">（系统内置角色标识不可修改）</span>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="role_type" id="role_type" required lay-verify="required" class="layui-input"
                            <?php if ($role->role_type == 1) : ?>disabled<?php endif; ?>>
                        <?php foreach ($role_type_options as $key => $value) : ?>
                        <option value="<?= $key ?>" <?php if ($role->role_type == $key) : ?>selected<?php endif; ?>>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="data_scope" id="data_scope" required lay-verify="required" class="layui-input">
                        ...
                        <option value="<?= $key ?>" <?php if ($role->data_scope == $key) : ?>selected<?php endif; ?>>
                            <?= htmlspecialchars($value) ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="number" name="role_sort" id="role_sort" 
                           placeholder="请输入排序号" class="layui-input" style="width: 150px;"
                           value="<?= htmlspecialchars($role->role_sort) ?>">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="role_status" value="1" title="启用" 
                           <?php if ($role->role_status == 1) : ?>checked<?php endif; ?>>
                    <input type="radio" name="role_status" value="0" title="禁用" 
                           <?php if ($role->role_status == 0) : ?>checked<?php endif; ?>>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea name="role_remark" id="role_remark" placeholder="请输入角色备注" 
                              class="layui-textarea" style="width: 400px; height: 100px;">
                        <?= htmlspecialchars($role->role_remark) ?>
                    </textarea>
                </div>
            </div>
