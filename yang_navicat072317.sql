...
CREATE TABLE `auth_menus`  (
  ...
  INDEX `idx_deleted_at`(`deleted_at` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 920733860755423248 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '菜单/功能表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of auth_menus
-- ----------------------------
INSERT INTO `auth_menus` VALUES (920733860755423001, 0, '首页', 'layui-icon-snowflake', '/backend/index', 'dashboard/Index', 'dashboard:view', 100, 1, '2026-07-23 07:48:11', '2026-07-23 08:39:14', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423002, 0, '内容管理', 'layui-icon-slider', '', 'Layout', 'content:view', 90, 1, '2026-07-23 07:48:11', '2026-07-23 08:39:21', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423003, 0, '运营管理', 'layui-icon-rate-half', '/operation', 'Layout', 'operation:view', 80, 1, '2026-07-23 07:48:11', '2026-07-23 08:39:33', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423004, 0, '系统管理', 'layui-icon-login-wechat', '/system', 'Layout', 'system:view', 70, 1, '2026-07-23 07:48:11', '2026-07-23 08:39:48', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423005, 0, '书签管理', 'layui-icon-login-weibo', '/bookmark', 'bookmark/Index', 'bookmark:view', 60, 1, '2026-07-23 07:48:11', '2026-07-23 08:39:39', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423006, 0, '文章管理', 'layui-icon-cellphone', '/content/article', 'content/article/Index', 'article:view', 10, 1, '2026-07-23 07:48:11', '2026-07-23 08:39:56', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423007, 920733860755423004, '分类管理', 'layui-icon-login-qq', '/content/category', 'content/category/Index', 'category:view', 9, 1, '2026-07-23 07:48:11', '2026-07-23 08:39:43', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423008, 920733860755423004, '友情链接', 'layui-icon-rate-solid', '/content/friendlink', 'content/friendlink/Index', 'friendlink:view', 8, 1, '2026-07-23 07:48:11', '2026-07-23 08:39:02', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423009, 920733860755423006, '文章列表', 'layui-icon-bot', '/content/article/list', 'content/article/List', 'article:list', 10, 1, '2026-07-23 07:48:11', '2026-07-23 08:36:08', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423010, 920733860755423006, '添加文章', 'layui-icon-bot', '/content/article/add', 'content/article/Add', 'article:add', 9, 1, '2026-07-23 07:48:11', '2026-07-23 08:36:10', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423011, 920733860755423006, '编辑文章', 'layui-icon-bot', '/content/article/edit', 'content/article/Edit', 'article:edit', 8, 1, '2026-07-23 07:48:11', '2026-07-23 08:36:10', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423012, 920733860755423006, '删除文章', 'layui-icon-bot', '/content/article/delete', 'content/article/Delete', 'article:delete', 7, 1, '2026-07-23 07:48:11', '2026-07-23 08:36:11', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423013, 920733860755423003, '横幅管理', 'layui-icon-folder', '/operation/banner', 'operation/banner/Index', 'banner:view', 20, 1, '2026-07-23 07:48:11', '2026-07-23 08:37:34', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423014, 920733860755423003, '广告位管理', 'layui-icon-folder', '/backend/adpositions', 'operation/ad/Index', 'ad:view', 19, 1, '2026-07-23 07:48:11', '2026-07-23 08:43:44', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423015, 920733860755423002, '留言管理', 'layui-icon-folder', '/operation/feedback', 'operation/feedback/Index', 'feedback:view', 18, 1, '2026-07-23 07:48:11', '2026-07-23 08:37:36', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423016, 920733860755423003, '广告位列表', 'layui-icon-folder', '/backend/adpositions/list', 'operation/ad/List', 'ad:list', 10, 1, '2026-07-23 07:48:11', '2026-07-23 08:45:11', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423017, 920733860755423003, '广告位定义', 'layui-icon-folder', '/backend/adslots', 'operation/ad/Slots', 'ad:slots', 9, 1, '2026-07-23 07:48:11', '2026-07-23 08:46:56', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423018, 920733860755423003, '广告点击日志', 'layui-icon-folder', '/operation/ad/logs', 'operation/ad/Logs', 'ad:logs', 8, 1, '2026-07-23 07:48:11', '2026-07-23 08:37:14', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423019, 920733860755423004, '系统设置', 'layui-icon-rate-half', '/system/config', 'system/config/Index', 'config:view', 30, 1, '2026-07-23 07:48:11', '2026-07-23 08:38:43', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423020, 920733860755423004, '菜单管理', 'layui-icon-rate-half', '/system/menu', 'system/menu/Index', 'menu:view', 29, 1, '2026-07-23 07:48:11', '2026-07-23 08:38:43', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423021, 920733860755423004, '权限管理', 'layui-icon-rate-half', '/system/permission', 'system/permission/Index', 'permission:view', 28, 1, '2026-07-23 07:48:11', '2026-07-23 08:38:44', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423022, 920733860755423004, '用户管理', 'layui-icon-rate-half', '/system/user', 'system/user/Index', 'user:view', 27, 1, '2026-07-23 07:48:11', '2026-07-23 08:38:44', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423023, 920733860755423004, '操作日志', 'layui-icon-rate-half', '/backend/operationlog', 'system/log/Index', 'log:view', 26, 1, '2026-07-23 07:48:11', '2026-07-23 08:47:38', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423024, 920733860755423002, '角色管理', 'layui-icon-music', '/system/permission/role', 'system/permission/Role', 'role:view', 10, 1, '2026-07-23 07:48:11', '2026-07-23 08:38:04', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423025, 920733860755423002, '权限规则', 'layui-icon-music', '/system/permission/rule', 'system/permission/Rule', 'rule:view', 9, 1, '2026-07-23 07:48:11', '2026-07-23 08:38:05', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423026, 920733860755423002, '角色菜单', 'layui-icon-music', '/system/permission/rolemenu', 'system/permission/RoleMenu', 'rolemenu:view', 8, 1, '2026-07-23 07:48:11', '2026-07-23 08:38:05', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423027, 920733860755423002, '角色权限', 'layui-icon-music', '/system/permission/roleperm', 'system/permission/RolePerm', 'roleperm:view', 7, 1, '2026-07-23 07:48:11', '2026-07-23 08:38:06', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423028, 920733860755423005, '书签列表', 'layui-icon-service', '/bookmark/list', 'bookmark/List', 'bookmark:list', 10, 1, '2026-07-23 07:48:11', '2026-07-23 08:38:32', NULL);
INSERT INTO `auth_menus` VALUES (920733860755423029, 920733860755423005, '我的书签', 'layui-icon-service', '/bookmark/my', 'bookmark/My', 'bookmark:my', 9, 1, '2026-07-23 07:48:12', '2026-07-23 08:38:33', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 934041315296100355 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '书签表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户操作动态表' ROW_FORMAT = Dynamic;
